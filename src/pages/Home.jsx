...
export default function Home() {
  return (
    <div className="bg-[#F8F8F8]">
      <section className="relative min-h-screen flex items-center justify-center text-center font-display text-white p-4">
        <img
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-red-700/80 to-red-900/50"></div>
      ...
      <section className="relative py-20 flex flex-col justify-center font-display text-center px-4">
        <div className="relative z-10 mt-10 md:mt-0 px-4 py-2">
          <span className="text-sm font-bold text-red-600 bg-red-500/20 px-5 py-2 rounded-full backdrop-blur-sm">
            COMO FUNCIONA
          </span>
          <h1 className="text-4xl md:text-6xl text-gray-900 font-bold mt-10 md:mt-15">
        ...
        <div className="relative flex flex-col md:flex-row justify-center mt-10 px-4 gap-16 md:gap-10">
          <div className="relative w-full max-w-xs mx-auto mb-16 md:w-75 md:mb-0">
            <div className="absolute -top-5 left-1/2 -translate-x-1/2 w-14 h-14 flex items-center justify-center text-white font-bold text-2xl rounded-xl bg-red-500">1</div>
            <div className="w-full h-auto min-h-[260px] bg-[#FFFAFA] border border-[#C6C6C6] shadow-lg rounded-2xl p-4 pt-12">
              <h1><FontAwesomeIcon icon={faUserPlus} className="text-[#eb1717] text-3xl bg-[#FFDDDD] mt-4 rounded-xl px-3 py-4" /></h1>
          ...
          <div className="relative w-full max-w-xs mx-auto mb-16 md:w-75 md:mb-0">
            <div className="absolute -top-5 left-1/2 -translate-x-1/2 w-14 h-14 flex items-center justify-center text-white font-bold text-2xl rounded-xl bg-blue-500">2</div>
            <div className="w-full h-auto min-h-[260px] bg-[#FFFAFA] border border-[#C6C6C6] shadow-lg rounded-2xl p-4 pt-12">
              <h1><FontAwesomeIcon icon={faCirclePlay} className="text-[#3535ff] text-3xl bg-[#D1D7F9] mt-4 rounded-xl px-3 py-4" /></h1>
          ...
          <div className="relative w-full max-w-xs mx-auto md:w-75">
            <div className="absolute -top-5 left-1/2 -translate-x-1/2 w-14 h-14 flex items-center justify-center text-white font-bold text-2xl rounded-xl bg-purple-500">3</div>
            <div className="w-full h-auto min-h-[260px] bg-[#FFFAFA] border border-[#C6C6C6] shadow-lg rounded-2xl p-4 pt-12">
              <h1><FontAwesomeIcon icon={faStar} className="text-[#792CF5] text-3xl bg-[#D6BBF9] mt-4 rounded-xl px-3 py-4" /></h1>
      ...
      <hr className="mt-20 md:mt-35 mx-auto max-w-6xl text-gray-400 border"/>
